...
#async def hilo(client, message: Message, _):
    ...
    #await message.reply_video(
        ...
        #caption=f"""[ٓ❍ | 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒊𝒕𝒂 .](https://t.me/JJXXH)\n\n[❍ | 𝒓𝒊𝒕𝒂 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒐𝒏 𝒕𝒆𝒍𝒆 .](https://t.me/JJXXH)\n\n[❍ |  𝒇𝒐𝒍𝒍𝒐𝒘 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒃𝒖𝒕𝒕𝒐𝒏𝒔 𝒃𝒆𝒍𝒐𝒘 .](https://t.me/JJXXH)""",
    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton(
                        "◌𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚒𝚝𝚊◌", url=f"t.me/UU_PATS"),
                    InlineKeyboardButton(
                        "◌ᴅᴇᴠᴇʟᴏᴘᴇʀ◌", url=f"t.me/UU_0B")
                ],[
                    InlineKeyboardButton(
                        "", callback_data="close"),
                    InlineKeyboardButton(
...
async def eslam(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       ...
       reply_markup=InlineKeyboardMarkup(
          [
               [
                    InlineKeyboardButton("", url=f"t.me/UU_0B"),
                    InlineKeyboardButton("رجوع", callback_data="ko")
                ],[
                    InlineKeyboardButton("", url=f"t.me/JJXXH"),
                ],[
...
async def spo(_, query: CallbackQuery):
    ...
    await query.edit_message_media(
       InputMediaVideo(
           ...
           "◌ هلا فيك في قسم تشغيل اغاني Spotify ♪\n\n• تقدر تشغيل الاغاني عن طريق الرد على الرابط او وضعه مع الامر .\n\n• مثال : [ `ريتا شغلي https://open.spotify.com/track/2GQB3Xe1J9D2sK90AtHfhI?si=aIuly9l-T-Gy5GvfZxpUiw&context=spotify%3Aplaylist%3A37i9dQZF1DXcJUwMZo8Ss1i=1616715870&l=ar` ]\n\n**تابع الفيديو للتوضيح اكثير .**"
       ),
       reply_markup=InlineKeyboardMarkup(
            [
                [
