...
def vgdg(client,message):
        message.reply_text(
            f"""✧ Welcome Baby,
ᴅᴇᴠᴇʟᴏᴘᴇʀ -› [𝙚𝙡𝙗𝙤𝙗 ♪](t.me/UU_0B)
ᴄʜᴀɴɴᴇʟ -› [𝑺𝒐𝒖𝒓𝒄𝒆 𝒓𝒊𝒕𝒂 ](t.me/UU_PATS)""", 
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "تحديثات ريتا 🍻", url=f"t.me/UU_PATS")
                    ]
                ]
            ),
...
@app.on_message(filters.command("ريتا نادي المطور", [".", ""]) & filters.group)
async def kstr(client: Client, message: Message):
       ...
       await message.reply_text(
        f"""- **ابشر ياعيوني ارسلت للمطور بيخش القروب ويشوف مشكلتك بأقرب وقت\n\n- تابع قناة البوت عشات تشوف التحديثات** -› [• Source Mira •](t.me/UU_PATS)""", disable_web_page_preview=True     
    )
...
@app.on_message(filters.regex("^ريتا$"))
...
async def down(client, message):
          m = await message.reply("**- ابشر تم اخفاء الازرار بنجاح\n- لو تبي تطلعها مرة ثانية اكتب ريتا**", reply_markup= ReplyKeyboardRemove(selective=True))


@app.on_message(filters.group & command("كيفية استخدام ريتا"))
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""- **هلا والله ياعيني عشان تفعل بوت ريتا اتبع الخطوات الي بالاسفل**
1 • ارفعه مشرف بكل الصلاحيات 
2 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب ريتا شغلي + اسم المقطع الصوتي
• مثال : ريتا شغلي واتنسيت
- لو واجهت مشكله كلم مطور البوت ~ @UU_0B""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                       "𝙚𝙡𝙗𝙤𝙗", user_id=2089102006),
                ],[
                    InlineKeyboardButton(
                        "• ضيفني لقروبك 🎻", url=f"https://t.me/TTJBBOT?startgroup=true"),
                ],
            ]
        ),
        disable_web_page_preview=True
...
async def addbot(client: Client, message: Message):
    await message.reply_text(f"""**- اهلين فيك بسورس ريتا ياحلو
• لو تبي تنصب مثل هالبوت تواصل مع مطور السورس
• عندك استفسار او اقتراح بخصوص البوت تواصل مع مطور البوت**
مطور السورس -› [𝙚𝙡𝙗𝙤𝙗](t.me/UU_0B)
قناة السورس -› [𝑺𝒐𝒖𝒓𝒄𝒆 𝒓𝒊𝒕𝒂 ](t.me/UU_PATS)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "تحديثات ريتا 🍻", url=f"https://t.me/UU_PATS"),
                ],[
                    InlineKeyboardButton(
                        "• ضيفني لقروبك 🎻", url=f"https://t.me/TTJBBOT?startgroup=true"),
                ],
...
REPLY_MESSAGEE = "- هلا فيك في قسم اوامر ريتا"
...
@app.on_message(filters.group & command("اوامر ريتا"))
...
• AppleMusic
• Spotify
- لو واجهت مشكلة تواصل مع مطور السورس @UU_0B**
- [𝑺𝒐𝒖𝒓𝒄𝒆 𝒓𝒊𝒕𝒂 ](t.me/UU_PATS)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
